---
id: F3024
titre: Un intérimaire a-t-il droit à un congé pour un projet de transition professionnelle ?
groupes: tous
theme: Travail - Formation
dossier: Formation des salariés du secteur privé
source: https://www.service-public.gouv.fr/particuliers/vosdroits/F3024
date: 2026-06-01
...
## Quelles sont les conditions d'ancienneté exigées pour bénéficier d'un congé pour un PTP ?
...
- Vous percevez une pension d'invalidité à condition que cette invalidité réduise les capacités de travail d'au moins 2/3
- Vous êtes un ancien militaire (et assimilé) et percevez une pension militaire d'invalidité
...
## Quelles informations comporte une demande de congé pour un PTP ?
...
## Quels délais faut-il respecter pour faire une demande de PTP ?
...
## Comment l'employeur doit-il traiter la demande de congé pour un PTP ?
...
À savoir : Si ce délai de 30 jours est dépassé, l'autorisation est présumée accordée.
...
## Comment faire une demande de financement du congé pour un PTP ?
...
## Quelle est la prise en charge du coût pédagogique pendant le congé pour un PTP ?

Votre commission régionale prend en charge tout ou partie des frais liés au coût pédagogique.

À savoir : La prise en charge de tout ou partie des frais annexes (transports, repas, hébergement) par la CPIR est possible.

## Quelle est la rémunération pendant le congé pour un PTP ?
...
## Quels sont les droits sociaux pendant le congé pour un PTP ?
...
Attention : Si la formation a lieu hors temps de travail, vous pouvez solliciter la commission paritaire interprofessionnelle régionale (CPIR) pour vous assurer que vous avez une protection sociale.
...
## Quel est le délai entre 2 PTP dans la même entreprise ?
...
Exemple : Vous avez bénéficié d'un PTP d'une durée de 9 mois. Ainsi, ce délai de franchise est de 90 mois (9*10) soit 7,5 ans. Ce chiffre est supérieur au plafond de 6 ans. Le délai retenu est donc de 6 ans.

## Comment l'intérimaire peut-il être accompagné pour mettre en oeuvre un PTP ?
