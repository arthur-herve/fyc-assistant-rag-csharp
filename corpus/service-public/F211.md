---
id: F211
titre: Handicap : établissement et service de pré-orientation (ESPO)
groupes: tous
theme: Travail - Formation
dossier: Formation des personnes handicapées
source: https://www.service-public.gouv.fr/particuliers/vosdroits/F211
date: 2025-05-09
...
## Qui peut intégrer un établissement et service de pré-orientation (ESPO) ?
...
## Comment intégrer un établissement et service de pré-orientation (ESPO) ?
...
## Où se déroulent les mesures proposées par l'établissement et service de pré-orientation (ESPO) ?
...
## Combien de temps dure l'accompagnement proposé par l'établissement et service de pré-orientation (ESPO) ?
...
## De quels droits bénéficie-t-on en intégrant un établissement et service de pré-orientation (ESPO) ?
...
## Que se passe-t-il à la fin de l'accompagnement en établissement et service de pré-orientation (ESPO) ?
