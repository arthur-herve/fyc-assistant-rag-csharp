---
id: F1650
titre: Qu'est-ce que la reconnaissance de la qualité de travailleur handicapé (RQTH) ?
groupes: tous
theme: Travail - Formation
dossier: Handicap et emploi dans le secteur privé
source: https://www.service-public.gouv.fr/particuliers/vosdroits/F1650
date: 2026-03-24
...
- L'orientation vers un établissement ou un service d'accompagnement par le travail (Ésat) ou vers un établissement ou un service de réadaptation professionnelle (ESRP).
...
### 1re demande d'AAH ou demande de renouvellement

Une procédure de RQTH est systématiquement engagée. Vous n'avez donc pas à faire de demande pour obtenir la RQTH.
...
## Comment est examinée la demande de la reconnaissance de la qualité de travailleur handicapé (RQTH) ?
...
## La décision de refus de la CDAPH d’attribuer la RQTH peut-elle faire l’objet d’un recours ?
...
## Combien de temps est attribuée la reconnaissance de la qualité de travailleur handicapé (RQTH) ?
...
## Comment renouveler la reconnaissance de la qualité de travailleur handicapé (RQTH) ?
...
À noter : Votre demande prolonge la RQTH jusqu'au rendu de la décision de la CDAPH portant sur son renouvellement, pour éviter toute interruption de vos droits.

## La reconnaissance de la qualité de travailleur handicapé (RQTH) impacte-elle le salaire et le contrat de travail ?
...
À noter : En cas de licenciement, le délai de préavis est doublé par rapport à celui prévu habituellement, sans pouvoir dépasser 3 mois.

## La reconnaissance de la qualité de travailleur handicapé (RQTH) ouvre-t-elle droit à la retraite anticipée ?
